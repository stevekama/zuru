...
<head>
    ...
    <title>Zuru administration</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Z</b>R</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>ZU</b>RU</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="#" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('backend.users',1)}}"><i class="fa fa-circle-o"></i>Vendors</a></li>
                        <li><a href="{{route('backend.users',2)}}"><i class="fa fa-circle-o"></i> Riders</a></li>
                        <li><a href="{{route('backend.users',0)}}"><i class="fa fa-circle-o"></i> Customers</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>Orders</span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="{{route('backend.rider_modes.list')}}">
                        <i class="fa fa-bicycle"></i> <span>Rider modes</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('backend.rider_modes.list')}}"><i class="fa fa-bicycle"></i>All modes</a></li>
                        <li><a href="{{route('backend.rider_modes.create')}}"><i class="fa fa-plus-circle"></i> Create new</a></li>
                    </ul>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">Zuru KE</a>.</strong> All rights
        reserved.
    </footer>
